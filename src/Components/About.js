                    ...
                    <Fade bottom>
                        <div className='about-text'>
                            ...
                            <p>2020 came with different unexpected challenges, from a pandemic virus, to natural disasters.
                                Tecned took this as an opportunity to help those in need and created the Tecened
                                Campus. It is located in one of the most technologically driven cities in Europe, Eindhoven. It
                                contributes to it, by hosting several small and medium size international organizations. Tecned gives them all the necessary tools to establish and grow their projects.</p>
                            <p> This technological hub has strived to become a sign of innovation across borders. Professionals
                                ...
                                influential Tech Hub in the world, the Tecned Campus is very well on its way to do it</p>
                            <p>
                                If you think your project or company should be in the Tecned Campus,  <a href="mailto:info@technicsproduction.nl" aria-label="Mail" rel="noopener noreferrer"> <span>send us an email </span> </a> with a
